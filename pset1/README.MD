...
*_PGPASSWORD='suaSenha' psql -U postgres_* (AQUI VOCÊ DEVE SE CONECTAR AO ROOT COM SUA SENHA) < *_~/caminho/para/o/arquivo_* (AQUI DEVE ESTAR O CAMINHO PARA O ARQUIVO) <br>
